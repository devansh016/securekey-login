...
return array(
    ...
    'Passkey_Login_Admin' => $baseDir . '/includes/admin/class-passkey-login-admin.php',
    'Passkey_Login_Authenticator' => $baseDir . '/includes/auth/class-passkey-login-authenticator.php',
    'Passkey_Login_Autoloader' => $baseDir . '/includes/class-passkey-login-autoloader.php',
    'Passkey_Login_Capabilities' => $baseDir . '/includes/class-passkey-login-capabilities.php',
    'Passkey_Login_Challenge' => $baseDir . '/includes/auth/class-passkey-login-challenge.php',
    'Passkey_Login_Credential' => $baseDir . '/includes/auth/class-passkey-login-credential.php',
    'Passkey_Login_Crypto' => $baseDir . '/includes/utils/class-passkey-login-crypto.php',
    'Passkey_Login_Installer' => $baseDir . '/includes/class-passkey-login-installer.php',
    'Passkey_Login_Logger' => $baseDir . '/includes/utils/class-passkey-login-logger.php',
    'Passkey_Login_Login_Form' => $baseDir . '/includes/frontend/class-passkey-login-login-form.php',
    'Passkey_Login_Network' => $baseDir . '/includes/multisite/class-passkey-login-network.php',
    'Passkey_Login_Network_Admin' => $baseDir . '/includes/admin/class-passkey-login-network-admin.php',
    'Passkey_Login_Network_Audit_List_Table' => $baseDir . '/includes/admin/class-passkey-login-network-audit-list-table.php',
    'Passkey_Login_Network_Site_List_Table' => $baseDir . '/includes/admin/class-passkey-login-network-site-list-table.php',
    'Passkey_Login_Plugin' => $baseDir . '/includes/class-passkey-login-plugin.php',
    'Passkey_Login_REST_API' => $baseDir . '/includes/api/class-passkey-login-rest-api.php',
    'Passkey_Login_Sanitizer' => $baseDir . '/includes/utils/class-passkey-login-sanitizer.php',
    'Passkey_Login_Settings' => $baseDir . '/includes/utils/class-passkey-login-settings.php',
    'Passkey_Login_Shortcodes' => $baseDir . '/includes/frontend/class-passkey-login-shortcodes.php',
    'Passkey_Login_Site_Manager' => $baseDir . '/includes/multisite/class-passkey-login-site-manager.php',
    'Passkey_Login_User_Profile' => $baseDir . '/includes/admin/class-passkey-login-user-profile.php',
    'Passkey_Login_User_Sync' => $baseDir . '/includes/multisite/class-passkey-login-user-sync.php',
    'Passkey_Login_WebAuthn' => $baseDir . '/includes/auth/class-passkey-login-webauthn.php',
